class AddIndexToForeignKeyFields < ActiveRecord::Migration
  def self.up
    ...
    add_index :subcriptions, [:user_id, :plan_id, :cart_id]
    add_index :suggestions, [:category_id, :user_id, :twitter_user_id]
    add_index :time_settings, [:timeframe_id, :user_id]
    add_index :time_settings, :twitter_user_id
    add_index :tweets, [:twitter_user_id, :buffer_preference_id]
    add_index :tweet_histories, [:user_id, :buffer_id]
    add_index :tweet_intervals, [:user_id, :timeframe_id]
    add_index :tweet_intervals, :twitter_user_id
